...
type PassportRoute = RouteProp<{ Passport: { scan: ScanRecord } }, 'Passport'>;

export default function PassportScreen() {
  const navigation = useNavigation();
  const route = useRoute<PassportRoute>();
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Text style={styles.partSubtype}>
            A full Digital Product Passport (BOM, DPP & QR details) will be
            implemented here, matching the web experience.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
